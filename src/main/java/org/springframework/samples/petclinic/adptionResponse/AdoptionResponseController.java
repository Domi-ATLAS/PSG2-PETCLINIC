...
public class AdoptionResponseController {
    ...
    public ModelAndView selectAdoptionResopnseForm(@PathVariable("adoptionRequestId") Integer adoptionRequestId,Principal principal){
    ...
    public ModelAndView selectAdoptionResopnse(@PathVariable("adoptionRequestId") Integer adoptionRequestId,AdoptionRequest adoptionRequest,Principal principal) throws DataAccessException, DuplicatedPetNameException{
    ...
    public ModelAndView deleteAdoptionResponse(@PathVariable("id") Integer id,@PathVariable("adoptionRequestId") Integer adoptionRequestId){
        ModelAndView res = new ModelAndView("redirect:/adoptionRequest/list");
