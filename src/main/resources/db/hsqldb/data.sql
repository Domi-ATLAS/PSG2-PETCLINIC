...
INSERT INTO cause(id, name, description, budget_target, achieved_budget, non_profit_organization, is_closed) 
VALUES (1, 'CausaEjemplo1', 'Para recaudar dinero para escuela', 320.0, 120.0, 'ZarrínONG', FALSE);
